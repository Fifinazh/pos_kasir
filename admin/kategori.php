                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a id="edit-category" data-id="<?php echo $rowCat['id'] ?>" href="tambah-kategori.php?edit=<?php echo $rowCat['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil"></span>
                                                            </a>
                                                            <a href="tambah-kategori.php?delete=<?php echo $rowCat['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm">
