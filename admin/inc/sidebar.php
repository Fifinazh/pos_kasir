 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
     <div class="app-brand demo">
         <a href="index.html" class="app-brand-link">
             ...
             <span class="app-brand-text demo menu-text fw-bolder ms-2">Moemart</span>
         </a>
     ...
     <ul class="menu-inner py-1">
                 ...
                 <ul class="menu-sub">
                     ...
                     <li class="menu-item">
                         <a href="level.php" class="menu-link">
                             <div data-i18n="Account">Level User</div>
                         </a>
                     </li>
                     <li class="menu-item">
                     ...
                     <li class="menu-item">
                         <a href="produk.php" class="menu-link">
                             <div data-i18n="Account">Produk Penjualan</div>
                         </a>
                     </li>
                 </ul>
             <?php endif ?>

             <?php if ($_SESSION['id_level'] == 2 or $_SESSION['id_level'] == 3) : ?>
                 <ul class="menu-sub">
                     <li class="menu-item">
                         <a href="stock.php" class="menu-link">
                             <div data-i18n="Account">Stock produk</div>
                         </a>
                     </li>
                 </ul>
             <?php endif ?>
         ...
         <?php if ($_SESSION['id_level'] == 2) : ?>
             <li class="menu-item">
                 <a href="javascript:void(0);" class="menu-link menu-toggle">
                     <i class="menu-icon tf-icons bx bx-dock-top"></i>
                     <div data-i18n="Account Settings">Transaksi Penjualan</div>
                 </a>
                 <ul class="menu-sub">
                     <li class="menu-item">
                         <a href="kasir.php" class="menu-link">
                             <div data-i18n="Account">Input Kasir</div>
                         </a>
                     </li>
                 </ul>
             </li>
         ...
         <?php if ($_SESSION['id_level'] == 1 or $_SESSION['id_level'] == 3) : ?>
             <li class="menu-item">
                 <a href="javascript:void(0);" class="menu-link menu-toggle">
                     <i class="menu-icon tf-icons bx bx-dock-top"></i>
                     <div data-i18n="Account Settings">Data Penjualan</div>
                 </a>
                 <ul class="menu-sub">
                     <li class="menu-item">
